...
function Show() {
  ...
  for (var key in hash) {
    var _new_hash = {};
    _new_hash.product = key;
    _new_hash.quantity = hash[key];
    arr.push(_new_hash); // console.log(key);
    // console.log(hash[key])
  }

  console.log(new_hash); // console.log(arr[0].product)
...
//# sourceMappingURL=cart.js.c69cceb12d7a8cfe0b72.hot-update.js.map