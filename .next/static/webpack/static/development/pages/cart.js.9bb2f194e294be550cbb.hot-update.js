...
function Show() {
  ...
  console.log(arr[0].product); // console.log(arr.map(product => <div>{product.title}</div>))

  return arr.map(function (product) {
    return __jsx(_components_Product__WEBPACK_IMPORTED_MODULE_3__["default"], {
      key: product.product,
      this_product: product.producr,
      __self: _this,
      __source: {
...
//# sourceMappingURL=cart.js.9bb2f194e294be550cbb.hot-update.js.map